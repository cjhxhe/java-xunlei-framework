...
public class TotpUtils {
    ...
    public static String generateSecretKey() {
        // UUID + 4位随机字符生成唯一标识
        String uniqueId = UUID.randomUUID() + RandomUtils.randomAlphabetic(4);
...
//        System.out.println(secret);
        String secret = "GBRDCMZYHBRDILJZGAZTKLJUGYZGMLJZME2DGLJRGY2TKNBVMVSDGNZRGRTGCZKD";
//        String code = TotpUtils.generateTOTP(secret, time, 6);
//        System.out.println(code);
//        System.out.println("6LC7CIHMHLLXKMBBDX7CPOWAHVVBZFE7RRQABBTH2F3EK2TMBVC2O3TLUNKMLLY5".length() + "--" + secret.length());
//        System.out.println(TotpUtils.getQRCodeStr("18758287305@lm", secret));
        System.out.println(TotpUtils.generateTOTP("HE2GGYRSGY3DKLJYGY3GGLJUGEZWMLLBGA2TMLLCGE3GCYJSG5SGCOBQG5SWURCI"));

//        String secret = "GUYDINBVMM2DSLJWHAYTELJUMNSWELLBMM2WILLGMEYDENDFGU2DSMTBMNRXC2DW";
//        System.out.println(TotpUtils.verify(secret, "868567"));
//        System.out.println(TotpUtils.getRemainingSeconds());
    }
