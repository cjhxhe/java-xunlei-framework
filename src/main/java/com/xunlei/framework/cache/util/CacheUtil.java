package com.xunlei.framework.cache.util;

import com.xunlei.framework.cache.CacheException;
import com.xunlei.framework.cache.IGroup;
...
import com.xunlei.framework.cache.config.KeyPropertyBean;
import com.xunlei.framework.cache.config.RefrenceBean;
...
public class CacheUtil {
    ...
    public static String[] getKeywordValues(Object o, String[] names) {
        ...
        Object[] values = CglibUtils.getPropertyValue(o, names);
        int i = 0;
    ...
    private static Object setPrimaryKeyRefBean(Map<String, Object> props,
        ...
        try {
            ...
            CglibUtils.setPropertyValues(bean, names, values);
            return bean;
        } catch (Exception e) {
