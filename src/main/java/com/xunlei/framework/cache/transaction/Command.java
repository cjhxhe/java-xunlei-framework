...
public class Command implements Serializable {
     ...
     */
    public static Command newSetExCommand(String cacheKey, String value, Integer seconds, CacheLevel level) {
        return new Command(Operation.SETEX, cacheKey, value, seconds, level);
    }
     ...
     * EXPIRE Command
     */
    public static Command newExpireCommand(String cacheKey, String value, CacheLevel level) {
        return new Command(Operation.EXPIRE, cacheKey, value, level);
    }
    ...
    private Command(Operation op, String cacheKey, String cacheValue, Integer seconds, CacheLevel level) {
        this(op, cacheKey, cacheValue, level);
