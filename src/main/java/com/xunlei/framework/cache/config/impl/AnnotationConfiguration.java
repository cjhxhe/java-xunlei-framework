...
import com.xunlei.framework.cache.annotations.*;
import com.xunlei.framework.cache.config.*;
...
public class AnnotationConfiguration extends AbstractConfiguration {
    ...
    private static class ParserAnnotation {
        ...
        private void parseGroup() throws ConfigurationException {
            ...
            Map<String, List<GroupBean>> groupMap = ListUtils.grouping(groups);
        ...
        private void parseMergings() throws ConfigurationException {
            ...
            Map<Class<?>, List<RefrenceBean>> refrences = ListUtils
